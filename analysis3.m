function analysis3(x1,x2,x3,x4,t,equ,i)
    ...
    figure(i)
    subplot(2,2,1); yyaxis left; stairs(t,x1(:,1)); hold on; stairs(t,equ,'k--','LineWidth',0.05);
    ...
    yyaxis right; stairs(t,x1(:,3)); xlabel('Time (seconds)'); ylabel('y_2: phi(t) (rad)');
    hold on; stairs(t,equ,'k--','LineWidth',0.05); % axis([-inf inf -pi/4 pi/4])
    ...
    subplot(2,2,2); yyaxis left; stairs(t,x2(:,1)); hold on; stairs(t,equ,'k--','LineWidth',0.05);
    ...
    yyaxis right; stairs(t,x2(:,3)); xlabel('Time (seconds)'); ylabel('y_2: phi(t) (rad)');
    ...
    subplot(2,2,3); yyaxis left; stairs(t,x3(:,1)); hold on; stairs(t,equ,'k--','LineWidth',0.05);
    ...
    yyaxis right; stairs(t,x3(:,3)); xlabel('Time (seconds)'); ylabel('y_2: phi(t) (rad)');
    hold on; stairs(t,equ,'k--','LineWidth',0.05);
    ...
    subplot(2,2,4); yyaxis left; stairs(t,x4(:,1)); hold on; stairs(t,equ,'k--','LineWidth',0.05);
    ...
    yyaxis right; stairs(t,x4(:,3)); xlabel('Time (seconds)'); ylabel('y_2: phi(t) (rad)');
    hold on; stairs(t,equ,'k--','LineWidth',0.05);
